...
If you would like to sideload the official beta app, you can look into using the AltStore or SideStore to sideload the IPA of the [most recent app release](https://github.com/advplyr/audiobookshelf-app/releases).
