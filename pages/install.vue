...
sudo apt install audiobookshelf</code>
    ...
    <pre>
        <code class="language-bash">wget https://advplyr.github.io/audiobookshelf-ppa/audiobookshelf_1.4.1_amd64.deb

sudo apt install ./audiobookshelf_1.4.1_amd64.deb</code>
      </pre>
