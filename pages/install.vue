...
sudo apt install audiobookshelf</code>
    ...
    <pre>
        <code class="language-bash">wget https://advplyr.github.io/audiobookshelf-ppa/audiobookshelf_1.7.2_amd64.deb

sudo apt install ./audiobookshelf_1.7.2_amd64.deb</code>
      </pre>
