...
sudo apt install audiobookshelf</code>
    ...
    <pre class="prose dark:prose-invert">
      <code class="language-bash">wget https://advplyr.github.io/audiobookshelf-ppa/audiobookshelf_2.2.0_amd64.deb

sudo apt install ./audiobookshelf_2.2.0_amd64.deb</code>
    </pre>
